...
export default function BookingLookupContent() {
  ...
  const { data: booking, isLoading, error } = useBookingByReference(bookingRef || '');

  useEffect(() => {
    if (error) {
      toast.error('Booking not found', 'Please check your reference and try again');
    }
  }, [error]);
          ...
          <Card>
            <CardContent className="pt-16 pb-16">
              ...
              <p className="text-sm text-muted-foreground mb-8">
                Please check the reference and try again, or contact support if you need assistance.
              </p>
            ...
            <CardContent className="p-6 space-y-8">
                      ...
                      <div className="flex items-center gap-4">
                        <div className="text-center">
                          <div className="text-2xl font-bold text-foreground">
                            {booking.fromCode || booking.fromLocation.split(' ')[0]}
                          </div>
                    ...
                    <div className="flex items-start gap-3">
                      ...
                      <div>
                        ...
                        <div className="text-sm text-muted-foreground break-all">
                          {booking.guestEmail || booking.user?.email || 'Not provided'}
                        </div>
                      </div>
                    </div>
                  </div>
              ...
              <div className="bg-primary/5 border border-primary/20 rounded-lg p-4">
                ...
                <p className="text-xs text-muted-foreground">
                  ...
                  <a href="mailto:support@evotransport.rw" className="text-primary hover:underline">
