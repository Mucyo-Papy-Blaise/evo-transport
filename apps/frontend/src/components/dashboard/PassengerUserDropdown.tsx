...
import { LogOut, LayoutDashboard, HomeIcon, ChevronDown } from "lucide-react";
import { cn } from "@/utils/utils";
import { useAuth } from "@/lib/auth/auth-context";

export function PassengerUserDropdown() {
    ...
    <div className="relative" ref={ref}>
      ...
      >
        <div className="hidden sm:block text-left leading-tight">
          ...
          <p className="text-[10px] text-muted-foreground">My trips</p>
        </div>
